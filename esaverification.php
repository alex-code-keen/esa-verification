	...
	<section class="dashboard-section">
		<div class="container">
			<div class="letter-space message-wrapper">
				...
				<p>As a customer of "Support Pets" <b>you now have exclusive access</b> to the first of its kind system that makes getting custom Landlord forms signed by the health professional a breeze.</p>
				<p>If your landlord or management has a custom ESA verification form that needs to be signed by the health professional not a problem. Use the link below to submit your request form.</p>
				<p><b>Please note:</b>  Our health professionals will provide the completed mental health portion of the form. Some landlords may also request that your veterinarian signs off that your pet's shots are up to date so plan ahead.</p>
				<p>To submit your landlord request form click the link below:</p>
				<a href="">Click here to request a custom landlord form</a>
				<p><br/><b class="underline">Get The Most From Your ESA!</b><br><a href="">Click Here</a> to Order The <b>Official ESA ™ Vest</b>
				<br/><a href="">Click Here</a> to Order The <b>Official ESA ™ ID Card (Free Certificate Included)</b><br/><br/></p>
				<p>Refer friends and family that are in need of our services. We'll take great care of them, And you"ll receive <b>$20 Amazon.com Gift Card</b> for every friend you refer!</p>
				<p><a href="">Click Here</a> to Refer & Earn $20 Amazon.com Gift Card</p>
